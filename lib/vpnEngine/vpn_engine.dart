...
class VpnEngine
{
  ...
  //vpn connection status snapchot
  static Stream<VpnStatus?>snapshotVpnStatus() => EventChannel(eventChannelVpnStatus).receiveBroadcastStream().map((eventStatus) => VpnStatus.fromJson(jsonDecode(eventStatus))).cast();
  ...
  //this function is to check if the vpn is connected or not
